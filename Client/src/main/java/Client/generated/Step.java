...
@XmlType(name = "Step", namespace = "http://schemas.datacontract.org/2004/07/SelfRootingServer.OpenRouteService", propOrder = {
    "distance",
    "duration",
    "instruction",
    "name"
...
public class Step {
    ...
    @XmlElementRef(name = "instruction", namespace = "http://schemas.datacontract.org/2004/07/SelfRootingServer.OpenRouteService", type = JAXBElement.class, required = false)
    protected JAXBElement<String> instruction;
    @XmlElementRef(name = "name", namespace = "http://schemas.datacontract.org/2004/07/SelfRootingServer.OpenRouteService", type = JAXBElement.class, required = false)

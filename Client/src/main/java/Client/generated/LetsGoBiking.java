 ...
 * 
 */
@WebServiceClient(name = "LetsGoBiking", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://localhost:8090/SelfRootingServer/LetsGoBiking?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8090/SelfRootingServer/LetsGoBiking?wsdl");
